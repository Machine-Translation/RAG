...
def parse_note(note_name, note_length):
    """Given a note from a midi file, parse it into its correct id"""
...
def get_notes():
    ...
    for file in glob.glob("training_files/*.mid"):
        ...
        try: # file has instrument parts
            ...
            notes_to_parse = s2.parts[0].makeRests(fillGaps=True, inPlace=False)
